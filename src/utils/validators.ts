...
type emailForElement = 'Email' | 'Password' | 'ConfirmPassword'

const emailFormErrorDispatcher = (forElement:emailForElement, dispatch:React.Dispatch<emailFormAction>, errorMessage:string) => {
    dispatch({type:`set${forElement}IsValid`,payload:false});
    dispatch({type:`set${forElement}ErrorMessage`,payload:errorMessage});
}

const emailFormSuccessDispatcher = (forElement:emailForElement, dispatch:React.Dispatch<emailFormAction>, enteredValue:string) => {
...
export const emailValidator = (enteredEmail:string, dispatch:React.Dispatch<emailFormAction>, successCallback?: () => void, failureCallback?: () => void) => {
...
export const passwordValidator = (enteredPassword:string, dispatch:React.Dispatch<emailFormAction>, successCallback?: () => void, failureCallback?: () => void) => {
...
export const confirmPasswordValidator = (enteredPassword:string, confirmPassword:string, dispatch:React.Dispatch<emailFormAction>, successCallback?: () => void, failureCallback?: () => void) => {
...
const phoneFormErrorDispatcher = (forElement:phoneForElement,dispatch:React.Dispatch<phoneFormAction>,errorMessage:string) => {
    dispatch({type:`setIs${forElement}Valid`,payload:false});
    dispatch({type:`set${forElement}ErrorMessage`,payload:errorMessage});
}
const phoneFormSuccessDispatcher = (forElement:phoneForElement,dispatch:React.Dispatch<phoneFormAction>,enteredValue:number) => {
    dispatch({type:`setIs${forElement}Valid`,payload:true});
    dispatch({type:`set${forElement}ErrorMessage`,payload:''});
    dispatch({type:`set${forElement}`,payload:enteredValue});
}

export const phoneNumberValidator = (enteredPhoneNumber:string,dispatch:React.Dispatch<phoneFormAction>,successCallback?:() => void,failureCallback?: () => void) => {
...
export const OTPValidator = (enteredOTP:string,dispatch:React.Dispatch<phoneFormAction>,successCallback?:() => void,failureCallback?: () => void) => {
